...
class HawaiiBios:
    ...
    def parse_positions(self):
        ...
        self.pciInfoPosition = BytesReader.read_uint16(self.rom, self.pos_pciInfoPosition)
        print('pciInfoPosition :', hex(self.pciInfoPosition))

        self.pos_headerPosition = 72
        self.headerPosition = BytesReader.read_uint16(self.rom, self.pos_headerPosition)
        print('headerPosition :', hex(self.headerPosition))

        self.pos_dataPointersPosition = 32 + self.headerPosition
        self.dataPointersPosition = BytesReader.read_uint16(self.rom, self.pos_dataPointersPosition)
        print('dataPointersPosition :', hex(self.dataPointersPosition))

        self.pos_powerTablePosition = 34 + self.dataPointersPosition
        self.powerTablePosition = BytesReader.read_uint16(self.rom, self.pos_powerTablePosition)
        print('powerTablePosition :', hex(self.powerTablePosition))

        self.pos_gpuVRMTablePosition = 68 + self.dataPointersPosition
        self.gpuVRMTablePosition = BytesReader.read_uint16(self.rom, self.pos_gpuVRMTablePosition)
        print('gpuVRMTablePosition :', hex(self.gpuVRMTablePosition))

        self.powerTableSize = BytesReader.read_uint16(self.rom, self.powerTablePosition)
        print('powerTableSize :', self.powerTableSize)

        self.pos_clockInfoOffset = 11 + self.powerTablePosition
        self.clockInfoOffset = BytesReader.read_uint16(self.rom, self.pos_clockInfoOffset)
        print('clockInfoOffset :', hex(self.clockInfoOffset))

        self.pos_fanTablePosition = 42 + self.powerTablePosition
        self.fanTablePosition = self.powerTablePosition + BytesReader.read_uint16(self.rom, self.pos_fanTablePosition)
        print('fanTablePosition :', hex(self.fanTablePosition))

        self.pos_gpuFrequencyTableOffset = 54 + self.powerTablePosition
        self.gpuFrequencyTableOffset = BytesReader.read_uint16(self.rom, self.pos_gpuFrequencyTableOffset)
        ...
        self.AUXvoltageOffset = BytesReader.read_uint16(self.rom, self.pos_AUXvoltageOffset)
        print('AUXvoltageOffset :', hex(self.AUXvoltageOffset))

        self.pos_memoryFrequencyTableOffset = 58 + self.powerTablePosition
        self.memoryFrequencyTableOffset = BytesReader.read_uint16(self.rom, self.pos_memoryFrequencyTableOffset)
        ...
        self.limitsPointersOffset = BytesReader.read_uint16(self.rom, self.pos_limitsPointersOffset)
        ...
        self.VCETableOffset = BytesReader.read_uint16(self.rom, self.pos_VCETableOffset)
        print('VCETableOffset :', hex(self.VCETableOffset))

        self.pos_VCEunknownStatesNum = 1 + self.VCETableOffset + self.powerTablePosition
        self.VCEunknownStatesNum = BytesReader.read_uint8(self.rom, self.pos_VCEunknownStatesNum)
        ...
        self.UVDTableOffset = BytesReader.read_uint16(self.rom, self.pos_UVDTableOffset)
        print('UVDTableOffset :', hex(self.UVDTableOffset))

        self.pos_UVDunknownStatesNum = 1 + self.powerTablePosition + self.UVDTableOffset
        self.UVDunknownStatesNum = BytesReader.read_uint8(self.rom, self.pos_UVDunknownStatesNum)
        ...
        self.SAMULimitTableOffset = BytesReader.read_uint16(self.rom, self.pos_SAMULimitTableOffset)
        ...
        self.ACPLimitTableOffset = BytesReader.read_uint16(self.rom, self.pos_ACPLimitTableOffset)
        ...
        self.tdpLimitOffset = 3 + BytesReader.read_uint16(self.rom, self.pos_tdpLimitOffset)
        ...
        self.CCCLimitsPosition = self.powerTablePosition + BytesReader.read_uint16(self.rom, self.pos_CCCLimitsPosition)
    ...
    def parse_overview(self):
        ...
        self.data['Overview'].append({
            'name': 'dev id',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_devIDstr))),
            'unit': '' ,
        ...
        self.data['Overview'].append({
            'name': 'vendor id',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_vendorID))),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'product data',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_productData))),
            'unit': '',
        ...
        self.data['Overview'].append({
            ...
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_structureLength))),
            'unit': '',
        ...
        self.data['Overview'].append({
            ...
            'value': str(hex(BytesReader.read_uint8(self.rom, self.pos_structureRevision))),
            'unit': '',
        ...
        class_code = hex(BytesReader.read_uint8(self.rom, self.pos1_classCode)) \
                     + ' - ' \
                     + hex(BytesReader.read_uint8(self.rom, self.pos2_classCode)) \
                     + ' - ' \
                     + hex(BytesReader.read_uint8(self.rom, self.pos3_classCode))
        self.data['Overview'].append({
            'name': 'structure revision',
            'value': class_code,
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'image length',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_imageLength))),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'revision level',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_revisionLevel))),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'code type',
            'value': str(hex(BytesReader.read_uint8(self.rom, self.pos_codeType))),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'indicator',
            'value': str(hex(BytesReader.read_uint8(self.rom, self.pos_indicator))),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'reserved',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_reserved))),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'SSVID',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_SSVID))[2:]),
            'unit': '',
        ...
        self.data['Overview'].append({
            'name': 'SSDID',
            'value': str(hex(BytesReader.read_uint16(self.rom, self.pos_SSDID))[2:]),
            'unit': '',
    ...
    def parse_powerplay(self):
        ...
        self.data['Powerplay'].append({
            'name': 'TDP max',
            'value': str(BytesReader.read_uint16(self.rom, self.powerTablePosition + self.tdpLimitOffset)),
            'unit': 'W',
        ...
        self.data['Powerplay'].append({
            'name': 'TDC limit',
            'value': str(BytesReader.read_uint16(self.rom, self.powerTablePosition + self.tdcLimitOffset)),
            'unit': 'A',
        ...
        self.data['Powerplay'].append({
            'name': 'Max ASIC temp',
            'value': str(BytesReader.read_uint16(self.rom, self.powerTablePosition + self.powerDeliveryLimitOffset + 2)),
            'unit': '°C',
    ...
    def parse_vddci(self):
        ...
        self.vddciTableCount = BytesReader.read_uint8(self.rom, self.pos_vddciTableCount)
        self.data['VDDCI states'].append({
            'name': 'VDDCI table count',
            'value': str(BytesReader.read_uint8(self.rom, self.pos_vddciTableCount)),
            'unit': '',
        ...
        for vddcicounter in range(self.vddciTableCount):
            ...
            self.data['VDDCI states'].append({
                ...
                'value': str(BytesReader.read_uint16(self.rom, pos_vddci_volt)),
                'unit': 'mV',
    ...
    def parse_mem_freq(self):
        ...
        for mem_freq_counter in range(self.memoryFrequencyTableCount):
            ...
            self.data['MEM freq table'].append({
                ...
                'value': str(BytesReader.read_uint16(self.rom, pos_mem_volt)),
                'unit': 'mV',
    ...
    def parse_gpu_mem(self):
        ...
        for gpu_freq_counter in range(self.gpuFrequencyTableCount):
            ...
            self.data['GPU freq table'].append({
                ...
                'value': str(BytesReader.read_uint16(self.rom, pos_gpu_volt)),
                'unit': 'mV',
    ...
    def parse_vce_limit(self):
        ...
        self.StartVCELimitTable_count = BytesReader.read_uint8(self.rom, self.pos_StartVCELimitTable)
        ...
        for vce in range(self.StartVCELimitTable_count):
            ...
            self.data['Start VCE limit table'].append({
                'name': 'DPM ' + str(vce) + ' : ' + str(BytesReader.read_uint8(self.rom, pos_vce + 2)),
                'value': str(BytesReader.read_uint16(self.rom, pos_vce)),
                'unit': 'mV',
    ...
    def parse_uvd_limit(self):
        ...
        self.StartUVDLimitTable_count = BytesReader.read_uint8(self.rom, self.pos_StartUVDLimitTable)
        ...
        for uvd in range(self.StartUVDLimitTable_count):
            ...
            self.data['Start UVD limit table'].append({
                'name': 'DPM ' + str(uvd) + ' : ' + str(BytesReader.read_uint8(self.rom, pos_uvd + 2)),
                'value': str(BytesReader.read_uint16(self.rom, pos_uvd)),
                'unit': 'mV',
    ...
    def parse_samu_limit(self):
        ...
        self.StartSAMULimitTable_count = BytesReader.read_uint8(self.rom, self.pos_StartSAMULimitTable)
        ...
        for samu in range(self.StartSAMULimitTable_count):
            ...
            self.data['Start SAMU limit table'].append({
                ...
                'value': str(BytesReader.read_uint16(self.rom, pos_samu)),
                'unit': 'mV',
    ...
    def parse_acp_limit(self):
        ...
        self.StartACPLimitTable_count = BytesReader.read_uint8(self.rom, self.pos_StartACPLimitTable)
        ...
        for acp in range(self.StartACPLimitTable_count):
            ...
            self.data['Start ACP limit table'].append({
                ...
                'value': str(BytesReader.read_uint16(self.rom, pos_acp)),
                'unit': 'mV',
    ...
    def parse_fan_profile(self):
        ...
        self.data['Fan Profile'].append({
            ...
            'value': str(BytesReader.read_uint8(self.rom, self.fanTablePosition + 1)),
            'unit': '°C',
        ...
        self.data['Fan Profile'].append({
            'name': 'Temp target 1',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 2)),
            'unit': '100 °C',
        ...
        self.data['Fan Profile'].append({
            'name': 'Temp target 2',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 4)),
            'unit': '100 °C',
        ...
        self.data['Fan Profile'].append({
            'name': 'Temp target 3',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 6)),
            'unit': '100 °C',
        ...
        self.data['Fan Profile'].append({
            'name': 'Fan speed 1',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 8)),
            'unit': '100 %',
        ...
        self.data['Fan Profile'].append({
            'name': 'Fan speed 2',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 10)),
            'unit': '100 %',
        ...
        self.data['Fan Profile'].append({
            'name': 'Fan speed 3',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 12)),
            'unit': '100 %',
        ...
        self.data['Fan Profile'].append({
            'name': 'Max temp',
            'value': str(BytesReader.read_uint16(self.rom, self.fanTablePosition + 14)),
            'unit': '100 °C',
        ...
        self.data['Fan Profile'].append({
            ...
            'value': str(BytesReader.read_uint8(self.rom, self.fanTablePosition + 16)),
            'unit': '°C',
        ...
        self.data['Fan Profile'].append({
            'name': 'PWM fan max',
            'value': str(BytesReader.read_uint8(self.rom, self.fanTablePosition + 17)),
            'unit': '%',
    ...
    def parse_vrm_setting(self):
        ...
        self.vrmList_size = BytesReader.read_uint16(self.rom, self.pos_vrmList_size)
        ...
        for vrm in range(2, self.vrmList_size, 2):
            ...
            temp = BytesReader.read_uint16(self.rom, pos_temp)
            if hex(temp) in vrm_types:
                value = BytesReader.read_uint16(self.rom, self.gpuVRMTablePosition + 8 + vrm)
                self.data['VRM settings'].append({
